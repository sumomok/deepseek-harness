...
export const zh = {
  ...
  'image.dropDesc': '最多 {count} 张图片，每张 {size}；文本内容会随消息发送，发送前留意其中的密码或密钥',
...
export const en = {
  ...
  'image.dropDesc': 'Up to {count} images, {size} each; text content is sent as-is — check for passwords or secrets before sending',
