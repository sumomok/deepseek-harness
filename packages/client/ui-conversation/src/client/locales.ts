...
export const zh = {
  ...
  'secretConfirm.addTitle': '添加确认',
  'secretConfirm.addMessage': '这些文件通常用于存放密码或密钥：{names}。仍要添加吗？',
  'secretConfirm.separator': '、',
  'secretConfirm.addAnyway': '仍要添加',
  'secretConfirm.dontAdd': '不添加',
  'secretConfirm.chipLabel': '密钥文件',
  'secretConfirm.chipLabelTitle': '这类文件通常存放密钥',
  'secretConfirm.notice': '{name} 这类文件通常存放密钥',
...
export const en = {
  ...
  'secretConfirm.addTitle': 'Add confirmation',
  'secretConfirm.addMessage': 'These files commonly hold passwords or keys: {names}. Add anyway?',
  'secretConfirm.separator': ', ',
  'secretConfirm.addAnyway': 'Add anyway',
  'secretConfirm.dontAdd': "Don't add",
  'secretConfirm.chipLabel': 'Secret file',
  'secretConfirm.chipLabelTitle': 'Files like this usually hold secrets',
  'secretConfirm.notice': 'Files like {name} usually hold secrets',
