...
export const zh = {
  ...
  'image.dropTitle': '图片或文本文件拖到此处即可添加',
  'image.dropDesc': '最多 {count} 张图片，每张 {size}；文本文件会作为附件加入，模型按需读取，发送前留意其中的密码或密钥',
  ...
  'file.notText': '仅支持文本文件',
  'file.invalidName': '文件名无效，请重命名后重试',
  'file.sendFailed': '文件发送失败（{reason}），请重新添加文件后再试',
  'file.open': '点击展开或收起文件内容',
  'file.loading': '文件内容加载中…',
  'file.loadFailed': '文件内容加载失败',
  'file.subagentUnsupported': '子智能体会话暂不支持文件',
  'secretConfirm.title': '发送确认',
  'secretConfirm.message': '这些文件通常用于存放密码或密钥：{names}。仍要发送吗？',
  'secretConfirm.separator': '、',
  'secretConfirm.sendAnyway': '仍要发送',
  'secretConfirm.dontSend': '先不发送',
  'secretConfirm.chipLabel': '密钥文件',
  'secretConfirm.chipLabelTitle': '这类文件通常存放密钥，发送前会再向你确认',
  'secretConfirm.notice': '{name} 这类文件通常存放密钥，发送前会再向你确认',
  ...
  'referent.notFound': '该文件已不存在，可能已被移动或删除。',
...
export const en = {
  ...
  'image.dropTitle': 'Drag images or text files here to add them',
  'image.dropDesc': 'Up to {count} images, {size} each; text files are attached, and the model reads them on demand — check for passwords or secrets before sending',
  ...
  'file.notText': 'Only text files are supported',
  'file.invalidName': 'Invalid file name; rename it and try again',
  'file.sendFailed': 'Sending files failed ({reason}); re-add them and try again',
  'file.open': 'Click to expand or collapse the file content',
  'file.loading': 'Loading file content…',
  'file.loadFailed': 'Failed to load file content',
  'file.subagentUnsupported': 'Subagent sessions do not support files yet',
  'secretConfirm.title': 'Send confirmation',
  'secretConfirm.message': 'These files commonly hold passwords or keys: {names}. Send anyway?',
  'secretConfirm.separator': ', ',
  'secretConfirm.sendAnyway': 'Send anyway',
  'secretConfirm.dontSend': "Don't send",
  'secretConfirm.chipLabel': 'Secret file',
  'secretConfirm.chipLabelTitle': 'Files like this usually hold secrets; you will be asked again before sending',
  'secretConfirm.notice': 'Files like {name} usually hold secrets; you will be asked again before sending',
  'secretConfirm.noticeRemove': 'Remove',
  ...
  'referent.notFound': 'This file no longer exists — it may have been moved or deleted.',
