...
export function ChatView({
  useSession, useSessions, useStore, renderSlot, sessionId, openFile, loadOlder, loadImage, loadFile, openReferent,
  inspectCall, chatScroll, forkAt, fileMentions, referents, t,
}: ChatViewSlotProps) {
