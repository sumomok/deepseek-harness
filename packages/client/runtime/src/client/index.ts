...
export { DirectoryBrowseError, PathOpenError, WorkspaceCreateError, WorkspaceRuntime } from './workspaces/service.ts'
...
export type {
  DirectoryEntry, DirectoryListing, ProbeResult, WorkspaceId, WorkspaceView,
