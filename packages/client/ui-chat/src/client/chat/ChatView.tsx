...
import type { ChatViewSlotProps, RenderUserActions } from '../contract/slots.ts'
...
export function ChatView({
  useSession, useChat, useSessions, useStore, actions, renderSlot, sessionId, openFile, loadOlder, loadImage,
  loadFile, openReferent, openView, chatScroll, forkAt, fileMentions, referents, useTranscriptView, t,
}: ChatViewSlotProps) {
