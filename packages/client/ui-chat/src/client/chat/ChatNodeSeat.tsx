...
export const ChatNodeSeat = memo(function ChatNodeSeat({
  ...
  loadImage, renderMessageImages, renderUserActions, fileMentions, useStore, actions, renderSlot, t,
}: ChatNodeSeatProps) {
  ...
  const owner = useMemo<ChatNodeOwnerProps | null>(() => node === undefined
    ...
    loadImage, renderMessageImages, renderUserActions, fileMentions, turnProcess,
  ])
