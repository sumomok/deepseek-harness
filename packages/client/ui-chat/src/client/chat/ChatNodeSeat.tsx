...
export const ChatNodeSeat = memo(function ChatNodeSeat({
  ...
  loadImage, renderMessageImages, renderUserActions, fileMentions, loadFile, openReferent,
  ...
  const owner = useMemo<ChatNodeOwnerProps | null>(() => node === undefined
    ...
    loadImage, renderMessageImages, renderUserActions, fileMentions, loadFile, openReferent, turnProcess,
  ])
