...
export const zh = {
  ...
  'message.compaction.failed': '上下文压缩失败',
  'message.compaction.failed.detail': '这次没能整理出摘要，对话内容没有变化，稍后会再试一次。',
  'message.think': '思考',
...
export const en = {
  ...
  'message.compaction.commandTitle': 'compact',
  'message.compaction.failed': 'Context compaction failed',
  'message.compaction.failed.detail': 'The summary could not be written this time, so nothing in the conversation changed. It will be tried again.',
  'message.think': 'Think',
