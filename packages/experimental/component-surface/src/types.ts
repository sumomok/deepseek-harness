/**
 * Pure types of this package's vendor-view half: the ONE home of the
 * `content-component/shown` session-event declaration and of the shape a
 * deployment writes a view in, free of the host-side value imports (zod,
 * dsh-tools, node) the rest of the package carries.
 *
