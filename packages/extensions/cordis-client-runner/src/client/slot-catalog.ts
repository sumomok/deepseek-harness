...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    source: 'packages/experimental/content-column/src/client/index.ts:57',
  },
  {
    key: 'conversation',
    kind: 'single',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: ask_user_question, bash, content_read, cordis_define, cordis_run, cordis_stop, cordis_undefine, edit, glob, grep, read, show_chart, skill, todo_write, web_fetch, web_search, write',
    hookContext: '',
    slotInject: '',
