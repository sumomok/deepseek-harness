...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, compaction-failure, compaction-running, context, manual-compaction, model-retry, steering, system-prompt, tool-call, turn-error, turn-max-tokens, turn-process, turn-tail, unknown, user, workflow-run',
    ...
    occupants: [
      ...
      'client-ui-chat CompactionRunningNodeView key \'compaction-running\'',
      'client-ui-chat CompactionFailureNodeView key \'compaction-failure\'',
  ...
  {
    key: 'conversation.chat.stats.usageLabel',
    kind: 'single',
    scope: 'session',
  ...
  },
  {
    ...
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:387',
  },
  {
