...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:367',
  },
  {
    ...
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:355',
  },
  {
  ...
  },
  {
    ...
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:361',
  },
  {
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: ask_user_question, bash, cordis_define, cordis_run, cordis_stop, cordis_undefine, edit, glob, grep, read, show_chart, skill, todo_write, web_fetch, web_search, write',
    hookContext: '',
    slotInject: '',
