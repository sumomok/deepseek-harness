...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    source: 'packages/experimental/content-column/src/client/index.ts:56',
  },
  {
    key: 'conversation',
    kind: 'single',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: component-action, dismiss-content-entry, show-content-page, show-content-view',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.chat.node\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
