...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    source: 'packages/experimental/server-layout/src/client/index.ts:60',
  },
  {
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: component-action, content-navigated, dismiss-content-entry, select-content-entry, show-content-page, show-content-view',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.chat.node\' (client-ui-chat), so it exists while that entry is mounted',
    occupants: [
      'experimental-component-surface ActionCommandRow key \'component-action\'',
      'experimental-component-surface ViewCommandRow key \'show-content-view\'',
      'experimental-content-column HiddenCommandRow key \'dismiss-content-entry\'',
      'experimental-content-column HiddenCommandRow key \'select-content-entry\'',
      'experimental-content-frame HiddenCommandRow key \'show-content-page\'',
      'experimental-content-frame HiddenCommandRow key \'content-navigated\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.chat.commandview\', () => ctx.slots.register(\n      { name: \'conversation.chat.commandview\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:362',
  },
  {
  ...
  },
  {
    ...
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:385',
  },
  {
  ...
  },
  {
    ...
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:356',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      ...
      'experimental-server-sidebar ServerSidebarRoot',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: ask_user_question, bash, content_read, cordis_define, cordis_run, cordis_stop, cordis_undefine, edit, glob, grep, read, read_image, show_chart, skill, todo_write, web_fetch, web_search, write',
    hookContext: '',
    slotInject: '',
    ...
    occupants: [
      ...
      'experimental-content-frame ContentReadRow key \'content_read\'',
      'experimental-vue2-echarts-tool-poc ShowChartRow key \'show_chart\'',
