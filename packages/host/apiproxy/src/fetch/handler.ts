...
import {
  ...
  hostPickDirectoryRequestSchema, hostProbeTargetsRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'session.file': { schema: sessionFileRequestSchema, invoke: (api, r) => api.sessions.file(r) },
  ...
  'host.probeTargets': { schema: hostProbeTargetsRequestSchema, invoke: (api, r) => api.host.probeTargets(r) },
