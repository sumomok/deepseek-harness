...
`@haoran/dsh-mcp-servers` 0.1.2 joins the desktop built-ins listed in [`apps/desktop/README.md`](../../../../apps/desktop/README.md), vendored as `apps/desktop-server/vendor/haoran-dsh-mcp-servers-0.1.2.tgz` (sha256 `e865341b97ea38d5966666b578bc4b823a4a04c01d1fc56b50c3b37a548d4751`). It is an out-of-repository package from the `dsh-plugins` workspace and reaches the payload only as that `pnpm pack` archive, like every other built-in.
