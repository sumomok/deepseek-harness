 ...
 * `apps/desktop-shell` ships as an Electron app whose `node_modules` is packed into
 ...
 * the shell cannot import: `apps/desktop-shell` ships as an Electron app whose
