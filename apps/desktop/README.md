...
**Four plugins ship inside the installer and mount themselves on first launch**, so a fresh install has them without pnpm, a network round trip, or a `dsh plugin add`:
