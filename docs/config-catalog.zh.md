...
- `@deepseek-ai/dsh-experimental-component-surface` — 需要 `tools`（[`packages/experimental/component-surface/src/index.ts`](../packages/experimental/component-surface/src/index.ts)）
