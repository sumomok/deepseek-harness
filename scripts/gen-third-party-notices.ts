...
export const OVERRIDES: Record<string, { license?: string; repo?: string }> = {
  ...
  '@haoran/dsh-mcp-servers': { repo: 'apps/desktop-server/vendor/haoran-dsh-mcp-servers-0.1.2.tgz' },
  ...
  '@sumomok/dsh-balance': { repo: 'apps/desktop-server/vendor/sumomok-dsh-balance-0.4.2.tgz' },
