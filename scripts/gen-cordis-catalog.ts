...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  proseReferents: 'client-side slot-contract accessor (ProseReferents) — packages/client/ui-conversation/README.md owns the API',
...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  'connection/state': 'client-face transport signal — packages/client/runtime/README.md owns the API',
  'locale/change': 'client-face locale switch signal — packages/client/locale/README.md owns the API',
  'referent/open': 'client-face reference-open interception seam — packages/client/runtime/README.md owns the API',
