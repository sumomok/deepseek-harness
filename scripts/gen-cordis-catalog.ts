...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  contentSurface: 'content-surface.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  referent: 'client-side interface-typed browser service (IReferent) — packages/api/session-controller/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ContentSurfaceDraft: 'content-surface.md',
  ContentSurfaceEntry: 'content-surface.md',
  ContentSurfaceExtractor: 'content-surface.md',
  ContentSurfaceRecord: 'content-surface.md',
  ContentSurfaceResolved: 'content-surface.md',
  ContentSurfaceView: 'content-surface.md',
  ...
  SessionFileRequest: 'session.md',
  SessionFileValue: 'session.md',
  ...
  ProbeResult: 'session.md',
  SessionProbeTargetsRequest: 'session.md',
  SessionProbeTargetsValue: 'session.md',
